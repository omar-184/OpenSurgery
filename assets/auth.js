    ...
    area.innerHTML =
      '<div class="profile">'+
        ...
        '<div class="profile-menu" id="profile-menu">'+
          ...
          (user.role === "admin" ? '<a href="'+root+'admin.html"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4Z"/></svg>Edit site content</a>' : '')+
          '</div>'+
